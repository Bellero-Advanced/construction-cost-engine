...
Comparative analysis across six regions over a nine-month period shows
that retailer prices for cement exceed the CGD baseline by an average of
22.9\%, that prices in the Southern region are 22.9\% higher than those
in the Central region (consistent with long-distance transportation
costs), and that the Construction Materials Index issued by the Trade
Policy and Strategy Office shows a linear upward trend of 0.4 points
per month with $R^{2} = 0.989$. These findings indicate that relying
solely on official reference prices for cost estimation carries a
material risk of deviation from real market prices, which can in turn
affect the adequacy of project budgets and the outcome of competitive
tenders.
