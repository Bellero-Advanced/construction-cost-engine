...
\usepackage{tikz}
\usetikzlibrary{shapes.geometric,shapes.misc,arrows.meta,positioning,fit,backgrounds,calc,matrix,decorations.pathreplacing}
\usepackage{pgfplots}
...
% TypeScript / JSON ไม่มีใน listings — define เอง (TypeScript ต่อยอดจาก HTML เพราะ JavaScript ก็ไม่มี)
\lstdefinelanguage{TypeScript}{
  morekeywords={interface,type,enum,readonly,implements,namespace,declare,public,private,protected,abstract,as,is,keyof,satisfies,unknown,never,async,await,export,import,from,let,const,var,function,return,if,else,for,while,do,switch,case,break,continue,new,this,super,class,extends,try,catch,throw,null,undefined,true,false},
  morecomment=[l]{//},
  morecomment=[s]{/*}{*/},
  morestring=[b]",
  morestring=[b]',
