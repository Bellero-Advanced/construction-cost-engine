...
% Option A — TH Sarabun New (ต้อง upload .ttf เข้า fonts/ ก่อน)
% ─────────────────────────────────────────────────────────
% ดาวน์โหลด 4 ไฟล์จาก https://www.f0nt.com/release/th-sarabun-new/
% หรือ https://github.com/SIPA-CTH/THFonts (THSarabunNew)
% แล้วใส่ใน fonts/ ของ Overleaf project:
%   fonts/THSarabunNew.ttf
%   fonts/THSarabunNew Bold.ttf
%   fonts/THSarabunNew Italic.ttf
%   fonts/THSarabunNew BoldItalic.ttf
%
% Uncomment 7 บรรทัดนี้ + comment Option B ด้านล่าง:
% \setmainfont[
%   Path=./fonts/,
%   Extension=.ttf,
...
% Option B — Norasi (default, ทำงานทุก distribution ไม่ต้อง upload)
% ─────────────────────────────────────────────────────────
